...
namespace WikiViewer.Core.Services
{
    public static class ThemeManager
    {
        ...
        private static string GetDefaultThemeCss()
        {
            ...
            html.dark-theme .fluent-enabled html, html.dark-theme .fluent-enabled body {
                background-color: rgba(30, 30, 30, 0.3) !important;
        }
            .mw-parser-output {
                padding: 24px;
            ...
            html.dark-theme .fluent-enabled .infobox, html.dark-theme .fluent-enabled table.wikitable, html.dark-theme .fluent-enabled .navbox, html.dark-theme .fluent-enabled .ambox, html.dark-theme .fluent-enabled .box-Multiple_issues, html.dark-theme .fluent-enabled .side-box, html.dark-theme .fluent-enabled #mp-topbanner, html.dark-theme .fluent-enabled #mp-left, html.dark-theme .fluent-enabled #mp-right, html.dark-theme .fluent-enabled #mp-middle, html.dark-theme .fluent-enabled #mp-lower, html.dark-theme .fluent-enabled #mp-bottom, html.dark-theme .fluent-enabled .ombox {
                background-color: rgba(44, 44, 44, 0.7) !important;
                border-color: rgba(255, 255, 255, 0.1) !important;
        }
            table.wikitable {
            ...
            html.dark-theme .fluent-enabled table[style*='background:#f3f9ff'][style*='float:right'][style*='border:1px dashed #aaa'] {
                background-color: rgba(44, 44, 44, 0.7) !important;
                border-color: rgba(255, 255, 255, 0.1) !important;
        }
            .bar-chart {
            ...
            html.dark-theme .bl-available, html.dark-theme .bl-leaked {
                color: #30d158;
        }
