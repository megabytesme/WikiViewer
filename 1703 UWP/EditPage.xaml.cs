    ...
    public sealed partial class EditPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (AppSettings.ConnectionBackend == ConnectionMethod.HttpClientProxy)
                ...
                _apiWorker = new WebViewApiWorker();
        ...
        private async void PreviewButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var postData = new Dictionary<string, string> { { "action", "parse" }, { "format", "json" }, { "title", _pageTitle }, { "text", WikitextEditor.Text }, { "prop", "text" }, { "disablelimitreport", "true" } };
        ...
        private async void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LoadingOverlay.Visibility = Visibility.Collapsed;
                var dialog = new ContentDialog { Title = "Save Failed", Content = $"The page could not be saved. The server reported the following error:\n\n{ex.Message}", CloseButtonText = "OK" };
        ...
        private async void CancelButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var dialog = new ContentDialog { Title = "Discard Changes?", Content = "You have unsaved changes. Are you sure you want to discard them?", PrimaryButtonText = "Discard", CloseButtonText = "Cancel" };
