...
namespace _1703_UWP.Controls
{
    public sealed partial class PageHeader : UserControl
    {
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register("Title", typeof(string), typeof(PageHeader), new PropertyMetadata(null, OnTitleChanged));

        private static void OnTitleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var control = d as PageHeader;
            control.PageTitleTextBlock.Text = e.NewValue as string;
            control.PageTitleTextBlock.Visibility = string.IsNullOrEmpty(e.NewValue as string) ? Visibility.Collapsed : Visibility.Visible;
        }
